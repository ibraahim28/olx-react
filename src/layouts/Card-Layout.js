  ...
  return (
    <div className="px-4 my-5 w-screen ">
      ...
      <div className="flex w-max-screen py-5">
        {data.map((v, i) => (
          <div key={i} className="w-1/5 mx-[2.5%] flex flex-col gap-3 border-gray-300 border-[1.5px] cursor-pointer rounded-lg">
            <div className="w-full h-full ">
              <img className="aspect-video  size-full rounded-t-lg" src={v.images} alt={v.title} />
            </div>
